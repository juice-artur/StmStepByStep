...
static void SSD1306_Command(uint8_t cmd) {
    HAL_I2C_Mem_Write(&hi2c1, SSD1306_ADDR, 0x00, I2C_MEMADD_SIZE_8BIT, &cmd, 1, 10);
}
...
void SSD1306_UpdateScreen(void) {
    ...
    HAL_I2C_Mem_Write(&hi2c1, SSD1306_ADDR, 0x40, I2C_MEMADD_SIZE_8BIT, buffer,
                      SSD1306_WIDTH * SSD1306_PAGES, 100);
}
...
void SSD1306_WriteChar(char ch) {
    ...
    for (int i = 0; i < 5; i++)
    {
        buffer[cursor_x + i + (cursor_y * SSD1306_WIDTH)] = font[ch - 0x20][i];
    }
    
    buffer[cursor_x + 5 + (cursor_y * SSD1306_WIDTH)] = 0;
    cursor_x += 6;
